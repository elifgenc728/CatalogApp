...
class UIHelper {
  ...
  // MUZ LOGIN COLORS
  static const Color MUZ_PRIMARY_COLOR = Color(0xFFFFD164);
  ...
  static const Color STRAWBERRY_PRIMARY_COLOR = Color(0xFFA13636);
  static const Color STRAWBERRY_SECONDARY_COLOR = Color(0xFF801515);
  ...
  static const Color BLUEBERRY_BLUE = Color(0xFF1A3265);
  static const Color BLUEBERRY_BLACK = Color(0xFF0D1423);
  ...
  static const Color POMEGRANATE_PRIMARY_COLOR = Color(0xFF740C1D);
  static const Color POMEGRANATE_SHADOW_COLOR = Color(0x60E84964);
  ...
  // FIG LOGIN COLORS
  static const Color FIG_PRIMARY_COLOR = Color(0xFF293489);
  ...
  static const Color WATERMELON_SHADOW = Color(0x40000000);
  static const Color WATERMELON_SH = Color(0xF2185C04);

  // PINEAPPLE LOGIN COLOR
  static const Color PINEAPPLE_PRIMARY_COLOR = Color(0xFFD0C028);
  static const Color PINEAPPLE_SECONDARY_COLOR = Color(0xFFF1F0F2);
  static const Color PINEAPPLE_SHADOW = Color(0x30000000);

  // PEAR LOGIN COLOR
  static const Color PEAR_PRIMARY_COLOR = Color(0xFF0C745A);

  // GLOBAL COLORS
  static const Color SPOTIFY_COLOR = Color(0xFF097D32);
  ...
  static const Color FACEBOOK_COLOR = Color(0xFF146292);
